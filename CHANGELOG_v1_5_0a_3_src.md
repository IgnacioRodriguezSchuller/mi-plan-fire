...
- **Cabeceras igualadas** (petición del dueño): titular de Seguimiento `displayLg`→`displayXxl` (iguala a Aprende); eyebrow de Aprende `caption`/`faint`→`SectionTag` accent (iguala al resto). *Nota: Plan/Proyección/Datos/Hogar siguen en `displayLg` — unificación global pendiente de visto bueno.*
